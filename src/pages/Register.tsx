...
import { PlayCircle, Eye, EyeOff, ArrowLeft, Building2, User } from "lucide-react";
      ...
      <div className="w-full max-w-md">
        ...
        <Card className="border-0 shadow-xl">
          <CardHeader className="text-center">
            <CardTitle className="text-2xl font-bold text-slate-800">Criar Conta Gratuita</CardTitle>
            <CardDescription>
