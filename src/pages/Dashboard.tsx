                      ...
                      <div key={meeting.id} className="flex items-center justify-between p-4 rounded-lg bg-white/5 hover:bg-white/10 transition-colors cursor-pointer">
                        ...
                        <div className="flex items-center space-x-3 ml-4">
                          <Badge 
                            variant="outline"
                            className={`${
                              meeting.status === 'Analisado' ? 'bg-green-600/20 text-green-300 border-green-500/30' :
                              meeting.status === 'Processando' ? 'bg-yellow-600/20 text-yellow-300 border-yellow-500/30' :
              ...
              <Card className="bg-black/20 border-white/10 backdrop-blur-sm">
                ...
                <CardContent>
                  <div className="space-y-4">
                    ...
                    <div className="flex justify-between items-center">
                      <span className="text-slate-300">Horas analisadas</span>
